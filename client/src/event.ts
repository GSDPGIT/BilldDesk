export const IPC_EVENT = {
  ...
  // 静默模式扩展（自用，被控端关屏/锁屏/隐私模式）
  silent_lockWorkstation: 'silent_lockWorkstation',
  silent_monitorOff: 'silent_monitorOff',
  silent_privacyMode: 'silent_privacyMode',
  silent_privacyMode_off: 'silent_privacyMode_off',
  silent_privacyMode_get: 'silent_privacyMode_get',
  silent_lockOnDisconnect: 'silent_lockOnDisconnect',
  silent_lockOnDisconnect_get: 'silent_lockOnDisconnect_get',
  silent_remote_disconnected: 'silent_remote_disconnected',
  silent_exit: 'silent_exit',
  silent_renderer_ping: 'silent_renderer_ping',
};
